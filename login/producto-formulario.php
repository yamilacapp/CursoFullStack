  ...
  if ($_FILES["archivo"]["error"] === UPLOAD_ERR_OK) {
    ...
    if(isset($_POST["btnGuardar"])){
      ...
      if(isset($_GET["id"])&&$_GET["id"]>0){
        ...
        if($imagenAnterior!=$producto->imagen){
        ...
        $producto->imagen=isset($nombreImagen)&&$nombreImagen!=null?$nombreImagen: "";
        $producto->insertar();
           ...
           <div class="col-10">
            <form action="" method="POST" enctype="multipart/form-data"></form>
              <div class="row">
               ...
               <button class="btn btn-warning" name="btnBorrar" type="submit">Borrar</button>
              </div>
             </div>
             <div class="row my-3">
