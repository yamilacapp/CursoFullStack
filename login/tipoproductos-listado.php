      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Listado de tipo de producto</h1>
          ...
          <div class="row mb-3">
            ...
            <div class="col-12 button">
             <button class="btn btn-primary"> <a href="tipoproducto-formulario.php"> Nuevo</a></button>
            </div>
             ...
             <div class="col-12">
               <table class=" table table-hover border">
                  ...
                  <tr>
                     ...
                     <td> <a href="tipoproducto-formulario.php?id=<?php echo $tipoProducto->idtipoproducto ?>"><i class="fas fa-search"></i></a>
                  </tr>
