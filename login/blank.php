      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">Nuevo producto</a>
            <a class="collapse-item" href="utilities-border.html">Listado de productos</a>
            <a class="collapse-item" href="utilities-animation.html">Tipo de productos</a>
