        ...
        <div class="container-fluid">
          ...
          <div class="row my-3">
            ...
            <div class="col-6 form-group">
                ...
                <input type="date" class="form-control" id="fecha" name="fecha" value="<?php echo $venta->fecha; ?>">
             </div >
             <div class="col-6 form-group">
                <label for="time">Hora:</label>
                <input type="time" id="time" name="time" class="form-control" value="<?php echo $venta->fecha; ?>" >
             </div >
             <div class="col-6 form-group">
             ...
             <div class="col-6 form-group">
                ...
                <input type="number" class="form-control" id="precio" name="precio" value="<?php echo $venta->preciounitario; ?>">
             ...
             <div class="col-6 form-group">
                ...
                <input type="number" class="form-control" id="total" name="total"  value="<?php echo $venta->total; ?>">
